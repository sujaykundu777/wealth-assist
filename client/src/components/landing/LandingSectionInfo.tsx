...
import InsightsFeature from "@/assets/images/feature-insights.png";
import InsightsFeatureDark from "@/assets/images/feature-insights-dark.png";
...
export const LandingSectionInfo = ({
  ...
  useEffect(() => {
    let imageToSet = InsightsFeature.src;
    ...
    if (theme === "system") {
      ...
      imageToSet =
        systemTheme === "dark" ? InsightsFeatureDark.src : InsightsFeature.src;
    } else if (theme === "dark") {
      imageToSet = InsightsFeatureDark.src;
    }
